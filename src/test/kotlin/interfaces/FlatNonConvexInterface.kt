...
@Suppress("unused")
class FlatNonConvexInterface(wWidth: Int, wHeight: Int, rank: Int, commSize: Int, nodeRank: Int)
    : RenderingInterfaceBase("FlatNonConvex", wWidth, wHeight, rank, commSize, nodeRank)
{
    ...
    override fun initializeParallelizationScheme(camera: Camera): ParallelizationBase {
        return FlatImagesParallelization("flat", volumeManagerManager, mpiParameters, camera)
    }
